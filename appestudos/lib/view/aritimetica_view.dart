...
class AritimeticaView extends StatefulWidget {
  const AritimeticaView({super.key});

  @override
  State<AritimeticaView> createState() => _AritimeticaView();
}

class _AritimeticaView extends State<AritimeticaView> {
  final AritimeticaController ctrl = GetIt.I.get<AritimeticaController>();
