...
class GrandezasView extends StatefulWidget {
  const GrandezasView({super.key});

  @override
  State<GrandezasView> createState() => _GrandezasView();
}

class _GrandezasView extends State<GrandezasView> {
  final GrandezasController ctrl = GetIt.I.get<GrandezasController>();
