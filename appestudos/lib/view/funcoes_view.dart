...
class FuncoesView extends StatefulWidget {
  const FuncoesView({super.key});

  @override
  State<FuncoesView> createState() => _FuncoesView();
}

class _FuncoesView extends State<FuncoesView> {
  final FuncoesController ctrl = GetIt.I.get<FuncoesController>();
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              child: Text(
                ctrl.finalizado ? 'Finalizado' : 'Finalizar Quiz',
