...
class GeoespacialView extends StatefulWidget {
  const GeoespacialView({super.key});

  @override
  State<GeoespacialView> createState() => _GeoespacialView();
}

class _GeoespacialView extends State<GeoespacialView> {
  final GeoespacialController ctrl = GetIt.I.get<GeoespacialController>();
